...
let package = Package(
    ...
    dependencies: [
        .package(url: "git@github.com:antwork/SQLCipher.git", from: "0.0.4")
    ],
    targets: [
        .target(name: "SQLite", dependencies: ["SQLiteObjc", "SQLCipher"], swiftSettings: [.define("SQLITE_SWIFT_SQLCIPHER")]),
